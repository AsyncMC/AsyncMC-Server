package org.asyncmc.server.util;
...
public class HumanStringComparator implements Comparator<String> {
    ...
    @NotNull
    private List<String> splitSymbols(@NotNull List<String> list) {
    ...
    private int compare(@NotNull List<String> l1, @NotNull List<String> l2) {
        int len1 = l1.size();
        int len2 = l2.size();
    ...
    private boolean detectOmittedNumber(@NotNull List<String> l1, int len1, int i, String str2, int strLen2, int minStrLen, @NotNull String commonPart1) {
        String combined;
    ...
    @NotNull
    private List<String> combineNegativeSign(@NotNull List<String> list) {
        int size = list.size();
        if (size < 2) {
            return list;
        }
    ...
    @NotNull
    private List<String> split(@NotNull String str) {
        int length = str.length();
        if (length == 0) {
