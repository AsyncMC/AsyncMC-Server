...
internal open class GenericEntityFactory(private val id: String?): EntityFactory() {
    override fun createEntity(remoteChunk: RemoteChunk, remoteEntity: RemoteEntity, chunk: BaseFullChunk): Entity? {
        return createEntity(remoteChunk, remoteEntity, id, chunk)
    }
}
